...
for i in xrange(common['conditions']):
    ...
    if i == 0:
        reset_condition = {
            # This is the down low position 
            #TRIAL_ARM:   {'data': np.array([0.7202076547291849, 0.3481062314783836, 1.4137955384634706, \
            #    -1.4526640901965866, -2.8858773016405372, -0.7608743945144045, 3.293726714344075]), \
            #    'mode': 1},
...
agent = {
    ...
    'targets': [{'position': (0.5, 0.5, 0.9), 'orientation': (0, 0, 0)}
        for _ in range(common['conditions'])],   
