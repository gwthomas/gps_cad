...
x0_info, target_info = [], [] #added from hyperparams_ilqr.py
for i in xrange(common['conditions']):
    ...
    #copying from hyperparams_ilqr.py
    ja_x0, ee_pos_x0, ee_rot_x0 = load_pose_from_npz(
        common['target_filename'], 'trial_arm', str(i), 'initial'
    )
    ja_aux, _, _ = load_pose_from_npz(
    ...
    #werent here initially, added from hyperparams_ilqr.py
...
agent = {
    ...
    'T_interpolation': 100,
    'x0': x0s,
    'x0_info': x0_info, #previously 'x0_wrist': ee_pos_x0,
    'ee_points_tgt': ee_tgts,
    'target_info': target_info, #previously 'target_wrist': ee_pos_tgt,
    ...
    'reset_timeout': 5 #added from hyperparams_ilqr.py
}
...
#this snippet found at https://github.com/cbfinn/gps/blob/master/experiments/pr2_tensorflow_example/hyperparams.py#L202
algorithm['policy_opt'] = {
    'type': PolicyOptTf,
    'network_params': {
