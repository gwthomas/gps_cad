...
(cl:defclass <ControllerParams> (roslisp-msg-protocol:ros-message)
  ((controller_to_execute
   ...
   (proxy
    :reader proxy
    :initarg :proxy
    :type gps_agent_pkg-msg:ProxyParams
    :initform (cl:make-instance 'gps_agent_pkg-msg:ProxyParams)))
)
...
(cl:ensure-generic-function 'proxy-val :lambda-list '(m))
(cl:defmethod proxy-val ((m <ControllerParams>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gps_agent_pkg-msg:proxy-val is deprecated.  Use gps_agent_pkg-msg:proxy instead.")
  (proxy m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ControllerParams>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'proxy) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ControllerParams>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'proxy) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ControllerParams>)))
  ...
  "a464f31d21ec09865b12270fb83a4180")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ControllerParams)))
  "Returns md5sum for a message object of type 'ControllerParams"
  "a464f31d21ec09865b12270fb83a4180")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ControllerParams>)))
  ...
  (cl:format cl:nil "int8 controller_to_execute  # controller enum, defined in gps_pb2~%~%CaffeParams caffe~%LinGaussParams lingauss~%TfParams tf~%ProxyParams proxy~%~%================================================================================~%MSG: gps_agent_pkg/CaffeParams~%string net_param # Serialized net parameter with weights (equivalent of prototxt file)~%float32[] bias~%float32[] scale~%float32[] noise~%int32 dim_bias~%uint32 dU~%~%================================================================================~%MSG: gps_agent_pkg/LinGaussParams~%# Time-varying Linear Gaussian controller~%uint32 dX~%uint32 dU~%float64[] K_t  # Should be T x Du x Dx~%float64[] k_t  # Should by T x Du~%~%================================================================================~%MSG: gps_agent_pkg/TfParams~%# Tf Params. just need to track dU.~%uint32 dU~%~%~%================================================================================~%MSG: gps_agent_pkg/ProxyParams~%uint32 dU~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ControllerParams)))
  "Returns full string definition for message of type 'ControllerParams"
  (cl:format cl:nil "int8 controller_to_execute  # controller enum, defined in gps_pb2~%~%CaffeParams caffe~%LinGaussParams lingauss~%TfParams tf~%ProxyParams proxy~%~%================================================================================~%MSG: gps_agent_pkg/CaffeParams~%string net_param # Serialized net parameter with weights (equivalent of prototxt file)~%float32[] bias~%float32[] scale~%float32[] noise~%int32 dim_bias~%uint32 dU~%~%================================================================================~%MSG: gps_agent_pkg/LinGaussParams~%# Time-varying Linear Gaussian controller~%uint32 dX~%uint32 dU~%float64[] K_t  # Should be T x Du x Dx~%float64[] k_t  # Should by T x Du~%~%================================================================================~%MSG: gps_agent_pkg/TfParams~%# Tf Params. just need to track dU.~%uint32 dU~%~%~%================================================================================~%MSG: gps_agent_pkg/ProxyParams~%uint32 dU~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ControllerParams>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'proxy))
))
