...
_SAMPLETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REF_TRAJ', index=20, number=20,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REF_OFFSETS', index=21, number=21,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TIMESTEP', index=22, number=22,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
_CONTROLLERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROXY_CONTROLLER', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TOTAL_CONTROLLER_TYPES', index=4, number=4,
      options=None,
      type=None),
  ],
  containing_type=None,
